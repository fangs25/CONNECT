...
def load_rna_data(modality="RNA+ATAC", dataset_name="issaacseq"):
    ...
    # Base data directory
    # base_dir = "/Users/spark/数据/Multiomic/1117"
    # dataset_path = os.path.join(base_dir, dataset_name)
    
    print(f"Loading {modality} data from {dataset_name}...")
    
    # # Load RNA data (true data)
    # rna_file = os.path.join(dataset_path, "rna_test.h5ad")
    # if not os.path.exists(rna_file):
    #     raise FileNotFoundError(f"RNA file not found: {rna_file}")
